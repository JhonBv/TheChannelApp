...
namespace API.TheChannel.BE.Controllers
{
    ...
    public class MessageModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FileName,FileUrl,DateAdded,isApproved,Location,FileSizeInBytes")] MessageModel messageModel)
        {
            if (ModelState.IsValid)
            {
                db.Message.Add(messageModel);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FileName,FileUrl,DateAdded,isApproved,Location,FileSizeInBytes")] MessageModel messageModel)
        {
            if (ModelState.IsValid)
            {
